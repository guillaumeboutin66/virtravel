...
public class TimelineViewAdapter extends ArrayAdapter<TimelineRow> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        VrPanoramaView rowPanorama = (VrPanoramaView) view.findViewById(R.id.panoramaVr);
        ...
        if(row.getPanorama() != null){
            rowPanorama.loadImageFromBitmap(BitmapFactory.decodeResource(view.getResources(), getRandomPicture(position)), null);
            rowPanorama.resumeRendering();
        }
